...
private:
   ...
   void __fastcall SetInterval(unsigned int Value);
   void __fastcall SetResolution(unsigned int Value);
...
__published:
   ...
   __property unsigned int Resolution={read=FResolution,write=SetResolution};
